...
void input_update_button(mouse_buttons_t key, int pressed);
void input_update_mouse_position(int x, int y);
void input_update_mouse_wheel(int z);

int input_is_key_up(keycodes_t key);
int input_is_key_down(keycodes_t key);
int input_is_button_up(mouse_buttons_t button);
int input_is_button_down(mouse_buttons_t button);
